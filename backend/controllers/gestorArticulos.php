...
class GestorArticulos{
	...
	public function mostrarImagenController($datos){
		...
		list($ancho, $alto) = getimagesize($datos);// devuelve array con los valores del ancho y alto de la imagen.
		...
		if($ancho < 800 || $alto < 400){
			...
			$aleatorio = mt_rand(100, 999); // ramdom para nombrar la imagen siempr diferente.
			$ruta = "../../views/images/articulos/temp/articulo".$aleatorio.".jpg";
			$origen = imagecreatefromjpeg($datos);
			$destino = imagecrop($origen, ["x"=>0, "y"=>0, "width"=>800, "height"=>400]);
			imagejpeg($destino, $ruta); // imagen recortada y destino se gurada en ruta
